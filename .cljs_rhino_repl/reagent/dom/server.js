...
var _STAR_non_reactive_STAR_37957 = reagent.impl.util._STAR_non_reactive_STAR_;
...
}finally {reagent.impl.util._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_37957;
}});
/**
...
var _STAR_non_reactive_STAR_37959 = reagent.impl.util._STAR_non_reactive_STAR_;
reagent.impl.util._STAR_non_reactive_STAR_ = true;

try{return (reagent.dom.server.module.call(null)["renderToStaticMarkup"])(reagent.impl.template.as_element.call(null,component));
}finally {reagent.impl.util._STAR_non_reactive_STAR_ = _STAR_non_reactive_STAR_37959;
}});
